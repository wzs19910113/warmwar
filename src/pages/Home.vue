        ...
        <nut-popup v-model="showEditRoom">
            <div class="row room-board" v-if="tempData.room">
                ...
                <div class="row risk">
                    ...
                    <p class="tip">{{[`收益减少，老化速度为零`,`收益和老化速度正常`,`收益提升，老化速度大幅提升；若房间有管理员，收益会根据房间类型和管理员能力值固定大幅提升`][tempData.room.risk-1]}}</p>
                </div>
                <div class="row risk">
                    <h3>参与平分电力:</h3>
